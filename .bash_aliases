...
alias mt='unimatrix -f -l aaAASSnngG -s 95 -a -c $(shuf -e red cyan blue magenta yellow -n 1) && logout'
alias mrt='unimatrix -f -l aAAASSnngG -s 92 -a | lolcat && logout'
...
alias cl='claude --model sonnet -p'
alias clh='claude --model haiku -p'
alias clo='claude --model opus -p'
